...
//      Operators
    ...
    SHarmonic1D& operator*=(const double & d);
    SHarmonic1D& multiply_guard(const double & d, const size_t Nbc);
...
// //      Access to the underlying array 
//         double& operator()(size_t i, size_t j, size_t k) {return (*sh)(i,j,k);} 
//         double  operator()(size_t i, size_t j, size_t k) const {return (*sh)(i,j,k);} 
//         double& operator()(size_t i) {return (*sh)(i);}             //1D-style 
//         double  operator()(size_t i) const {return (*sh)(i);}             //1D-style 

//         vector<double > xVec(size_t x, size_t y) const {return (*sh).d2d3c(x,y);}

// //      Operators
//         SHarmonic2D& operator=(const double& d);
...
//         double& operator()(size_t i, size_t j){return (*fi)(i,j);} //Fortran-style
//         double& operator()(size_t i){return (*fi)(i);}             //1D-style 

// //      Operators
//         Field2D& operator=(const double& d);
...
//      Operators
    ...
    DistFunc1D& operator*=(const double & d);
    DistFunc1D& multiply_guard(const double & d, const size_t Nbc);
    DistFunc1D& operator*=(const DistFunc1D& other);
    DistFunc1D& operator+=(const double & d);
    DistFunc1D& operator+=(const DistFunc1D& other);
...
//     // void Dx_vel(valarray<double>& vin);
...
//         SHarmonic1D* SHp(size_t s, size_t lh, size_t mh) const {return   (sp[s])(lh,mh); }
    ...
    State1D& operator*=(const State1D& other);
    State1D& operator*=(const double & d);
    State1D& multiply_guard(const double & d, const size_t Nbc);
    State1D& operator+=(const State1D& other);
...
//         State2D& operator=(const double& d);
//         State2D& operator*=(const State2D& other);
//         State2D& operator*=(const double& d);
//         State2D& operator+=(const State2D& other);
//         State2D& operator+=(const double& d);
