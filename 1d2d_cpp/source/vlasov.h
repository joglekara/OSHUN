...
//          Advance
    ...
    double getA1(size_t el, size_t em) {return A1(el,em);}
    double getA2(size_t el, size_t em) {return A2(el,em);}
    ...
    valarray< double > get_vr() {return vr;}
private:
    Array2D< double >      A1, A2, C2, C4;

    valarray< double >     B1, B2, C1, C3;
    valarray< double >  	vr;
...
private:
    ...
    double                 A100, C100, A210, B211, C311, A310;
    ...
    valarray< double >     pr, invdp, invpr;
