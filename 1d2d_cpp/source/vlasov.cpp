...
//         {
//             Exh(ix,iy) += (temp(0,ix,iy));
//             Eyh(ix,iy) += (temp(1,ix,iy));
...
:   A1(Nl+1,Nm+1), A2(Nl+1,Nm+1),
    ...
    pr(Algorithms::MakeCAxis((0.0),
      (1.0),
      dp.size())),
    invdp(Algorithms::MakeCAxis((0.0),
      (1.0),
      dp.size())),
    invpr(pr),
    ...
    neswdiag_il((Nm+1)*(2*Nl-Nm+2)/2),neswdiag_im((Nm+1)*(2*Nl-Nm+2)/2)
{
    ...
    // ------------------------------------------------------------------------ //  
    pr[0] = static_cast<double > (0.5*dp[0]);
...
//  -------------------------------------------------------- //
    ...
    //     valarray<double > Em(FEz.array());
    //     Em *= (-1.0)*ii;
    //     Em += FEy.array();
    //     valarray<double > Ep(FEz.array());
    //     Ep *= ii;
    //     Ep += FEy.array();
...
// {
    ...
    //                 Dh(1,0)(ip,ix) += double( A1(0,0).real()*vtemp[ip]*
    ...
    //                 Dh(l0-1,0)(ip,ix) += double( A2(l0,0).real()*vtemp[ip]*
    ...
    //                 Dh(il-1,0)(ip,ix) += double( A2(il,0).real()*tdfdx );
    //                 Dh(il+1,0)(ip,ix) += double( A1(il,0).real()*tdfdx );
...
//--------------------------------------------------------------
    ...
    valarray<double > invdp_local(invdp);
    double ld(el);
